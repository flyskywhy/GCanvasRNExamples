...
// ref to https://webglfundamentals.org/webgl/lessons/zh_cn/webgl-3d-textures.html
...
export default class Webgl3dTextures extends Component {
  constructor(props) {
    super(props);
    this.canvas = null;
    this.state = {
